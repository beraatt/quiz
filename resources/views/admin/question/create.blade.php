<x-app-layout>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('questions.store',$quiz->id) }}" enctype="multipart/form-data"> @csrf
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success btn-sm btn-block mt-2 ">Soru Oluştur</button>
                </div>
            </form>
        </div>
    </div>
